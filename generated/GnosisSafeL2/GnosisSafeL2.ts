...
export class GnosisSafeL2__execTransactionFromModuleReturnDataResult {
  value0: boolean;
  value1: Bytes;
...
export class GnosisSafeL2__getModulesPaginatedResult {
...
export class GnosisSafeL2 extends ethereum.SmartContract {
  static bind(address: Address): GnosisSafeL2 {
    return new GnosisSafeL2("GnosisSafeL2", address);
  }
  ...
  execTransactionFromModuleReturnData(
    ...
    data: Bytes,
    operation: i32
  ): GnosisSafeL2__execTransactionFromModuleReturnDataResult {
    let result = super.call(
      "execTransactionFromModuleReturnData",
    ...
    return new GnosisSafeL2__execTransactionFromModuleReturnDataResult(
      result[0].toBoolean(),
      result[1].toBytes()
    );
  }
  ...
  > {
    ...
    return ethereum.CallResult.fromValue(
      new GnosisSafeL2__execTransactionFromModuleReturnDataResult(
        value[0].toBoolean(),
        value[1].toBytes()
      )
    );
  ...
  getModulesPaginated(
    start: Address,
    pageSize: BigInt
  ): GnosisSafeL2__getModulesPaginatedResult {
    let result = super.call(
      "getModulesPaginated",
    ...
    return new GnosisSafeL2__getModulesPaginatedResult(
  ...
  try_getModulesPaginated(
    start: Address,
    pageSize: BigInt
  ): ethereum.CallResult<GnosisSafeL2__getModulesPaginatedResult> {
    let result = super.tryCall(
      "getModulesPaginated",
      "getModulesPaginated(address,uint256):(address[],address)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GnosisSafeL2__getModulesPaginatedResult(
